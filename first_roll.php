...
<link rel="stylesheet" href="https://codepen.io/ashleygalante/pen/nwoKh.css">
...
<body> 
  ...
  <div class="main-div container ">
    ...
    $sum = $first_dice + $second_dice;
		...
		$first='<br> <h2 > <center> <div class="d-inline p-2 bg-dark text-white">You Rolled : '.$sum.'</div></center> </h2> 
    <img class="src1" src="'.$dice1.'"> <img class="src" src="'.$dice2.'">';
    
		

	check($sum, $dice1, $dice2);
	function check($sum, $dice1, $dice2){
